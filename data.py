...
def init(Log_stream : StringIO):  
    ...
    neuroengine_medium = model.Model("Neuroengine-Medium", 4000)
    neuroengine_fast = model.Model("Neuroengine-Fast", 4000)
    models = [neuroengine_large, neuroengine_medium, neuroengine_fast]
    ...
    global configs
    large_stable = config.Config("Large-Stable", neuroengine_large, vicuna_chat, stable, [len_test])
    large_rp = config.Config("Large-RP", neuroengine_large, vicuna_chat, creative_rp, [len_test])
